...
fig.suptitle('Fig. 7 — Algorithm Performance Comparison (n=22)', fontsize=13, fontweight='bold')
fig.tight_layout()
fig.savefig(os.path.join(OUTPUT_DIR, 'fig7_comparison.png'), dpi=180, bbox_inches='tight')
plt.close(fig)
...
fig2.tight_layout()
fig2.savefig(os.path.join(OUTPUT_DIR, 'fig5_routes_DejaVu_Sans.png'), dpi=180, bbox_inches='tight')
plt.close(fig2)
...
fig11.tight_layout()
fig11.savefig(os.path.join(OUTPUT_DIR, 'fig4_aqp_route_DejaVu_Sans.png'), dpi=180, bbox_inches='tight')
plt.close(fig11)
